...
namespace tpcassebrique
{
    public class Balle : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            uneballe = new Objet(Game.Content.Load<Texture2D>("Balle11"), this.position_depart, new Vector2(TAILLEX, TAILLEY), this.vitesse_initiale);
        ...
        public void BougeBalle()
        {
            ...
            if (uneballe.Position.Y >= maxY)
            {
                ...
                estDemarre = false;
                if (Nbreballes == 2)
                    raquette.Uneraquette.Texture = Game.Content.Load<Texture2D>("raquette11");
                if (Nbreballes == 1)
                    raquette.Uneraquette.Texture = Game.Content.Load<Texture2D>("raquette11");
